...
## [2.80.0](https://github.com/weiyilai/emailengine/compare/v2.79.7...v2.80.0) (2026-09-01)
...
* add label/category filtering to message search ([c171c4e](https://github.com/weiyilai/emailengine/commit/c171c4e1efe582f7e532b69108110a1c48aa3ede))
...
* allow enabling Sentry error reporting from the admin UI ([a4076a4](https://github.com/weiyilai/emailengine/commit/a4076a4fa6658ccc998f9bfe35dddf015cd12b09))
...
* replace Bugsnag with self-hosted Sentry for error tracking ([62de831](https://github.com/weiyilai/emailengine/commit/62de831a2911da9b649fe693547ba09d70e2e481))
...
* surface token hash for identification in API, UI, and logs ([8e2a5a9](https://github.com/weiyilai/emailengine/commit/8e2a5a9f2bb5194e92575c34c0006a8c4e21888d))
* tag Sentry error reports with instance id and license key ([2e9683f](https://github.com/weiyilai/emailengine/commit/2e9683f27d54ff8fa7ba3f6f4453866fd135f173))
...
* align API response schemas with actual responses and fix uncovered API bugs ([abacbf6](https://github.com/weiyilai/emailengine/commit/abacbf66f048a77d00d180a831a97594380d8ed9))
* align remaining API response schemas with actual responses ([06136ab](https://github.com/weiyilai/emailengine/commit/06136abd20a97c45b25aac7f93653387eb55928a))
...
* assign unassigned accounts after license activation ([5677977](https://github.com/weiyilai/emailengine/commit/56779778eba27f2d1604ff06f17e5736a5ddee61))
...
* avoid 500 on GET /admin/totp without a partial-auth session ([b6f2394](https://github.com/weiyilai/emailengine/commit/b6f2394182379d94a05f95c84f5ce04ae6f87a05))
...
* count undecodable export queue entries as skipped ([72e2498](https://github.com/weiyilai/emailengine/commit/72e2498390f17ad24d5f7b1577540674d7e1fe09))
...
* do not crash at startup when a feature flag env variable is set to a falsy value ([98ad979](https://github.com/weiyilai/emailengine/commit/98ad97988e752fad9e2ae11eff63f35ffcf84976))
...
* extract gettext strings from the decomposed ui-routes modules ([227e60f](https://github.com/weiyilai/emailengine/commit/227e60ff4f354c5d0f55534877c8ab6fbdd92c7d))
...
* guard cross-thread download streams against early producer errors ([191ec62](https://github.com/weiyilai/emailengine/commit/191ec6204887c3abe78da7a9944e3165b19c0b87))
...
* list Outlook folders with slashes in the name ([dd35e7b](https://github.com/weiyilai/emailengine/commit/dd35e7b262a47f9395811d75c4bcc1d9ab4c6ec0))
...
* only reseed lost IMAP sync state when no stored state exists ([78e0141](https://github.com/weiyilai/emailengine/commit/78e0141e9f3478d2a2a1206c805258c6807a45d8))
...
* report correct nextAttempt time for queued messages ([d5ebdfb](https://github.com/weiyilai/emailengine/commit/d5ebdfb029b3ed331a8239ace7426f4f0704ae2e))
...
* resolve code review findings in Gmail bulk ops, exports, webhooks, and schemas ([f0ddb46](https://github.com/weiyilai/emailengine/commit/f0ddb4631fb924ddb93e0a99d0e20bc9f0cc8ee2))
...
* return 422 for unsupported label search and surface Outlook categories ([d981359](https://github.com/weiyilai/emailengine/commit/d981359b78b61d2c8a03e4e35086a4c9674ce53a))
...
* send correctly typed SMTP and IMAP proxy state change notifications ([3fbd27f](https://github.com/weiyilai/emailengine/commit/3fbd27fc08bb74f9738a3fc95d4177fa4978c263))
