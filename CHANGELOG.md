...
## [2.75.0](https://github.com/weiyilai/emailengine/compare/v2.74.0...v2.75.0) (2026-07-23)
...
* add audit logging for admin authentication events ([0ea15d4](https://github.com/weiyilai/emailengine/commit/0ea15d444ed589cd872b11190d07f7751f5cf54b))
* add configurable Gmail Pub/Sub subscription TTL setting ([ca33e7f](https://github.com/weiyilai/emailengine/commit/ca33e7f9101b3375d7e0001cdbe1d7a41a9442d3))
...
* add Gmail Subscriptions tab to OAuth config page ([3bd30bf](https://github.com/weiyilai/emailengine/commit/3bd30bf0bbc26600eae40d42e95ef7976257e4f2))
...
* add Outlook Service (client_credentials) provider for app-only Microsoft 365 access ([#587](https://github.com/weiyilai/emailengine/issues/587)) ([5f906cd](https://github.com/weiyilai/emailengine/commit/5f906cd540564afe2dc2024b4e17c2d5d9483ed2))
* add passkey (WebAuthn) authentication for admin login ([a39b362](https://github.com/weiyilai/emailengine/commit/a39b362152597bcc864307cd7c46cdc78a3808e6))
...
* always use persistent sessions and support remember-me for passkey login ([6a6fc74](https://github.com/weiyilai/emailengine/commit/6a6fc74748f92372e135e88478a9fa0f83cf690f))
...
* flag nested message/rfc822 attachments with encodedInMessage property ([7e51024](https://github.com/weiyilai/emailengine/commit/7e51024c690235e36cbbf8297939f0a41002b05e))
...
* add .catch() to fire-and-forget setMeta and track error fingerprints ([672a03e](https://github.com/weiyilai/emailengine/commit/672a03e2524bcaa26c4d3c908fa828f4e636999b))
...
* add lock to del() to prevent race with ensurePubsub, fix pubSubApp cleanup ([27f2bdd](https://github.com/weiyilai/emailengine/commit/27f2bdd4a9e3d7e913e7f4bed96084a278bb6312))
...
* always notify webhook workers when Pub/Sub app config changes ([e9f276a](https://github.com/weiyilai/emailengine/commit/e9f276ab528ad384bcbf5c370a0d0cb22e084cc5))
...
* auto-recover expired Gmail Pub/Sub subscriptions and expose status via API ([7961ceb](https://github.com/weiyilai/emailengine/commit/7961ceb8ce81688e5c3bb435a6c33ed3882afd7b))
...
* avoid redundant Redis call and concurrent backfill races in Pub/Sub setup ([05b02af](https://github.com/weiyilai/emailengine/commit/05b02afc1c14de1b8fa4e272d26da2056280731a))
...
* broaden Pub/Sub notification condition in oauth-routes.js ([cbe1380](https://github.com/weiyilai/emailengine/commit/cbe13800ab9460c41f5dcdcd4d7ae50f8e5e75e3))
...
* clean up Pub/Sub Redis keys on deletion, refresh stale instances, and localize UI labels ([3b35fa1](https://github.com/weiyilai/emailengine/commit/3b35fa19a6a8024a60d2ed21e9fcd69fda349481))
...
* clear stale pubSubFlag after restart and consolidate backfill push ([f67961f](https://github.com/weiyilai/emailengine/commit/f67961fbc590aa586ef40b65c2189b5dab4d89c0))
...
* correct pubSubApp property name in del() and add cleanup tests ([016ae0a](https://github.com/weiyilai/emailengine/commit/016ae0a98bc52eeee2bd1ec4f4d0ed58e92c507d))
...
* correct typo in Pub/Sub schema version log message ([2cc8e08](https://github.com/weiyilai/emailengine/commit/2cc8e085463ed550e341b027e592b5351784182e))
...
* eliminate redundant Redis ops in Pub/Sub pull loop and backfill ([c8ebe39](https://github.com/weiyilai/emailengine/commit/c8ebe393744eee46c3d19b5be413badd8ab315d6))
...
* fix export TTL expiration, cancellation cleanup, and expose truncated field ([019c05c](https://github.com/weiyilai/emailengine/commit/019c05c941842ae28668711e8f5c2e8a85d3b84b))
* fix lifecycle event races, lock TTL, and stale clearExisting in MS Graph subscriptions ([3f3cbac](https://github.com/weiyilai/emailengine/commit/3f3cbac843c4c221644492855d7c1beb41cd1da0))
* fix missing renewal retry, clock-skew gap, and incomplete pipeline error check ([8a8b5b6](https://github.com/weiyilai/emailengine/commit/8a8b5b68feb3edd7c984707a85ddb6d146739020))
* fix off-by-one retry cap and simplify MS Graph subscription code ([aa9afbc](https://github.com/weiyilai/emailengine/commit/aa9afbc5aea20d1bf775e59dbfd82842c4f8b701))
* fix Pub/Sub deletion race, add 429 handling, batch ACKs, and lock ensurePubsub ([744c354](https://github.com/weiyilai/emailengine/commit/744c354a062f63eedcec8de1a324a5d13519b9a7))
* fix retry boundary, lock races, and dropped lifecycle events in MS Graph subscriptions ([d62741d](https://github.com/weiyilai/emailengine/commit/d62741d2a2aafc47d831482b71ff24fa4c9d1883))
* fix silent 401/403 error suppression, floating promise, and recovery loop in Pub/Sub ([406211c](https://github.com/weiyilai/emailengine/commit/406211cbd62f7d3f1b811fbec81767f319219c63))
* fix stale subscription state blocking recovery and retry count persisting across reconnects ([60b77d5](https://github.com/weiyilai/emailengine/commit/60b77d5d7574abf728c5e1f015c0cecddd5d9fdd))
* fix subscription loss on subscriptionRemoved, lifecycle webhook timeout, and retry gaps ([62988ab](https://github.com/weiyilai/emailengine/commit/62988ab3b690ed98583fa01557a9c4145427e3ae))
...
* guard fire-and-forget setMeta calls and add Pub/Sub graceful shutdown ([45f7b64](https://github.com/weiyilai/emailengine/commit/45f7b64d7692b220ff14ec0e1c0e9deea84731de))
...
* guard null imapClient dereferences during async operations ([671bcee](https://github.com/weiyilai/emailengine/commit/671bcee4e81c7c0d6421617c3e25ec6906cb1abb))
* guard releaseLock against undefined, add 429 handling to Pub/Sub deletion ([d67ebe1](https://github.com/weiyilai/emailengine/commit/d67ebe138ca9663796eacc5a1c6b5b73e721e6c4))
...
* handle non-numeric error codes from Microsoft Graph in OAuth callback ([#580](https://github.com/weiyilai/emailengine/issues/580)) ([89fd9f7](https://github.com/weiyilai/emailengine/commit/89fd9f74db0cb32d4980b57b6c623e5d98b426a8))
* handle TimeoutError from AbortSignal.timeout in Pub/Sub pull loop ([c0e3036](https://github.com/weiyilai/emailengine/commit/c0e303641e4eb9f6cdca3c584861052b2bd91148))
* handle undici HeadersTimeoutError as transient in Pub/Sub and OAuth2 paths ([8b3b698](https://github.com/weiyilai/emailengine/commit/8b3b69880ab09119df4ca377d085db261eae2763))
...
* harden MS Graph subscription lifecycle, locking, cleanup, and error recovery ([8210056](https://github.com/weiyilai/emailengine/commit/8210056f7e7b00977fb5487323ff1b8f9f4b7a99))
...
* harden Pub/Sub deletion, IAM policy, and worker timeout cleanup ([0be7c3e](https://github.com/weiyilai/emailengine/commit/0be7c3eb04f3381306284e1e3790f7c3cc28cb5a))
* harden Pub/Sub pull loop resilience and fix projectId typo ([8124328](https://github.com/weiyilai/emailengine/commit/81243287f339b5fe40cddd0e1d127514d2e11f4a))
* harden Pub/Sub pull loop, message ACK, list pairing, and shutdown cleanup ([9e9775f](https://github.com/weiyilai/emailengine/commit/9e9775f6df97af42bdb8b799c2345a4564f8a77a))
* harden Pub/Sub pull loop, worker coordination, and OAuth app lifecycle ([529b705](https://github.com/weiyilai/emailengine/commit/529b7055dd4aeb0b1d80fabff3f139cf23f00252))
* harden Pub/Sub shutdown, loop scheduling, and abort lifecycle ([71b3ab4](https://github.com/weiyilai/emailengine/commit/71b3ab4625fa3304ae7a4413a3b0a64276948d7f))
* harden Pub/Sub shutdown, transient error handling, and input validation ([cfc6e0b](https://github.com/weiyilai/emailengine/commit/cfc6e0bb73902600b6eecc6bc955af85f06d9b0f))
* harden static file route with path confinement and pkg-only guard ([19cd5f6](https://github.com/weiyilai/emailengine/commit/19cd5f632baa7fb37f5d639f234c5374b371ab93))
...
* include ESM [@csstools](https://github.com/csstools) packages as pkg assets ([df9f6d2](https://github.com/weiyilai/emailengine/commit/df9f6d286b0fc2819edf0bf2f179dc0d6d2ce0d5))
* include failed jobs in /v1/outbox response ([b393676](https://github.com/weiyilai/emailengine/commit/b393676f2f877046d27b06d518a03dd256d5b7d9))
...
* localize error page strings using translation helper ([609ebb9](https://github.com/weiyilai/emailengine/commit/609ebb94d1e662ac661f7efe22f6608d7823fb85))
...
* login page divider logic, select() log level, and missing trailing newlines ([97ff93e](https://github.com/weiyilai/emailengine/commit/97ff93e2cc6c865a0f597a42a124e0abb140e34a))
...
* move pubsub status from unauthenticated /health to GET /v1/pubsub/status ([f6597ad](https://github.com/weiyilai/emailengine/commit/f6597addff4de1c23fbd88964702bc2425f14d0c))
...
* pin subdependency to avoid installing unsupported version ([045b8ce](https://github.com/weiyilai/emailengine/commit/045b8ce1a28c9cf9eecb26723589c5dcb4a28c21))
...
* prevent EISDIR crash on /static directory requests ([5b9c2db](https://github.com/weiyilai/emailengine/commit/5b9c2db2d3e8f46c55ef0dc7343b7fb730e52414))
* prevent EISDIR crash on static subdirectory requests in pkg ([4d5ef81](https://github.com/weiyilai/emailengine/commit/4d5ef81679e4fd7f5e8a55a260f2c29f99938ba4))
...
* prevent IMAP worker crash on ImapFlow unhandled rejection during IDLE recovery ([86ebb02](https://github.com/weiyilai/emailengine/commit/86ebb02c321ffa758966af1957509c10e20a35fc))
* prevent infinite loop and add retry backoff in account assignment ([f8b9e53](https://github.com/weiyilai/emailengine/commit/f8b9e533a821d1c34a869270fa489437ac80da93))
...
* prevent null dereference crash in getImapConnection during connection drops ([6a356fd](https://github.com/weiyilai/emailengine/commit/6a356fd20e1412a070c26c093108c4ea2a722a5c))
...
* prevent oscillating recovery loop for Pub/Sub apps missing googleProjectId ([8bdbc39](https://github.com/weiyilai/emailengine/commit/8bdbc39c790b7097b02459b558328c18584585a2))
...
* prevent permanently lost accounts after worker crashes ([3deabb5](https://github.com/weiyilai/emailengine/commit/3deabb55b195601bf0c14d248257cc8a4aac76d2))
...
* prevent transient network errors during OAuth2 token refresh from being misclassified as auth failures ([38fa212](https://github.com/weiyilai/emailengine/commit/38fa212092847b727ac1d02541103c032a983dc7))
* prevent unhandled promise rejections during mailbox sync ([e6174de](https://github.com/weiyilai/emailengine/commit/e6174defbf1c94f54ac7cbcb45eaa9e5c547926e))
...
* reduce Pub/Sub recovery log noise and respect backoff delay ([63cd78f](https://github.com/weiyilai/emailengine/commit/63cd78fcfd0c12934e488f6936109653371f0899))
...
* remove dead circuit breaker code from IMAP and webhooks workers ([da9295b](https://github.com/weiyilai/emailengine/commit/da9295b951d20a5817116195689dd3c964b3d996))
* remove dead redirectToSlash option from static directory handler ([f90339a](https://github.com/weiyilai/emailengine/commit/f90339a663913f47a6d1878225633a4f7cb4ac7e))
...
* remove Pub/Sub circuit breaker, fix 401/403 recovery handling ([b7017f3](https://github.com/weiyilai/emailengine/commit/b7017f34478dbb3bcedfb9a1e098a8a45cb0f83d))
* remove unnecessary min-height from login form ([f16940d](https://github.com/weiyilai/emailengine/commit/f16940d9957df114ce0ff4240107a82619a58705))
* reorder OAuth app deletion to prevent pull-loop gap, add startLoop tests ([129f96c](https://github.com/weiyilai/emailengine/commit/129f96c99ff9ff2552fa1c1962b1e0a652b8837e))
* replace custom Redis locks with ioredfour in Outlook subscription code ([019eaa1](https://github.com/weiyilai/emailengine/commit/019eaa1f26be504d127cb6c8a05dfe50d8a47b71))
...
* resolve lint errors, fix TTL null guard, and extract Pub/Sub constants ([4949431](https://github.com/weiyilai/emailengine/commit/4949431c8e05f06c5aafc3dfe93876ea8a2875b9))
* resolve livelock, timeout, and state corruption in MS Graph subscription lifecycle ([745334e](https://github.com/weiyilai/emailengine/commit/745334e8c55fcf4b0b3fc6adef2b37f6cf9aea61))
...
* retry transient errors during Pub/Sub resource deletion and log dropped messages ([b9d9de5](https://github.com/weiyilai/emailengine/commit/b9d9de56a50b37e0163ea4e9a954d65bc305004c))
...
* retry transient network errors in Gmail and Outlook API request functions ([08ea0da](https://github.com/weiyilai/emailengine/commit/08ea0daecaec73c58a91ac07df5d0f0ffc083a2f))
...
* show OAuth apps with failed Pub/Sub setup in subscriptions list ([14124cd](https://github.com/weiyilai/emailengine/commit/14124cd29baf107f1f82dff48695bc51cae4fd97))
...
* stop Pub/Sub instances on OAuth2 app deletion and harden lifecycle ([bc0ff75](https://github.com/weiyilai/emailengine/commit/bc0ff758cea8d8713485e3a28e81b16ee56d1dc7))
...
* surface TTL reconciliation failures to operators via ttlWarning meta flag ([6e5d5c5](https://github.com/weiyilai/emailengine/commit/6e5d5c5a97fb9aaff2662f3fe2f90c8226359b4a))
* switch pkg targets from node22 to node24 to fix Windows builds ([12522a7](https://github.com/weiyilai/emailengine/commit/12522a7b92d72684af49cd70c1c6d4bcafe1d4af))
...
* throw instead of silent return in select() null guard, revert redundant optional chaining ([cb7db50](https://github.com/weiyilai/emailengine/commit/cb7db5024e0b00f8a773328dd5e0009067bed0b6))
...
* treat DNS errors as transient in Google Pub/Sub polling loop ([ec33673](https://github.com/weiyilai/emailengine/commit/ec33673b47242fd7156b4641c9c4924a33eaf9e5))
...
* update imapflow to 1.2.15 to fix unhandled rejection crashes ([494a3f8](https://github.com/weiyilai/emailengine/commit/494a3f8cd9e71bc1fc1683bea2fc92474cb33206))
* update tests for getCurrentListing null guard changes ([a644f9c](https://github.com/weiyilai/emailengine/commit/a644f9c1c3f3e4cbce388e43bfa319f11f4a469c))
...
* validate fallback status codes in resolveOAuthErrorStatus ([d2b49e3](https://github.com/weiyilai/emailengine/commit/d2b49e3ad0c78c17a8aee6f1679fa3597d85ca4b))
