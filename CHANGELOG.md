...
## [2.82.0](https://github.com/weiyilai/emailengine/compare/v2.81.1...v2.82.0) (2026-09-23)
...
* **autodiscovery:** let the API carry credentials and the hosted form skip the settings step ([f78b62e](https://github.com/weiyilai/emailengine/commit/f78b62ec910899f7de83fbc972a44858f024b6ac))
...
* **api:** check isBounce for messages in the Inbox only ([de05eff](https://github.com/weiyilai/emailengine/commit/de05eff7d684cd7beeb227a912afa6aa0988b421))
...
* **api:** decide isBounce at fetch time instead of storing a marker ([2c81311](https://github.com/weiyilai/emailengine/commit/2c813117f95757c6cf656ae3f904042c3b458a7a))
...
* **api:** remove the bounces field and the store behind it ([b67acb9](https://github.com/weiyilai/emailengine/commit/b67acb9618754a108e32e4bafbef0b05d4773ade))
* **api:** report isBounce and relatedMessageId in message responses ([b551bfd](https://github.com/weiyilai/emailengine/commit/b551bfd7457466e8f51ff77540d0bb4afd59eb21))
...
* **api:** skip the server settings step by default for minted setup links ([2c43c60](https://github.com/weiyilai/emailengine/commit/2c43c6075614e9765160628a49d1e97f0f94f1c6))
...
* **deps:** move the packages that pin nodemailer onto 10.0.9 and dedupe the tree ([db2abd8](https://github.com/weiyilai/emailengine/commit/db2abd80319f9ab61406b1d222e357ffbd9ec8b0))
...
* **deps:** update bull-board and simplewebauthn ([66ab196](https://github.com/weiyilai/emailengine/commit/66ab196f623041a048b32817ad28352e97b3b336))
...
* **deps:** update imapflow to 2.0.6 ([07d5ea7](https://github.com/weiyilai/emailengine/commit/07d5ea7eb42cdb01fd9a091db043837ecd8e58d3))
* **deps:** update joi-messages to 1.1.3 for the Joi 18 validation messages ([c62b34c](https://github.com/weiyilai/emailengine/commit/c62b34cc56fd9ca221cdf1e990ac6145c7536236))
...
* **deps:** update nodemailer to 10.0.8 across the packages that pin it ([6dc08f7](https://github.com/weiyilai/emailengine/commit/6dc08f7ae47db4a7f537d8a13c3004aa9983a690))
...
* **docker:** bump the node:24-alpine base image digest ([7e6808b](https://github.com/weiyilai/emailengine/commit/7e6808be64cc099611746492c71fad2b701bdfcf))
* **docker:** health-check the container over 127.0.0.1, not localhost ([31ab205](https://github.com/weiyilai/emailengine/commit/31ab2051ca22d2da45c2079f6581babbdebb0659))
...
* **docker:** pass the commit hash as a build arg instead of reading a branch ref ([c2c03c8](https://github.com/weiyilai/emailengine/commit/c2c03c884ce061ad215ae612eaaafef00bf513ba))
...
* **i18n:** fill the empty plural forms in the certificate count ([d51803d](https://github.com/weiyilai/emailengine/commit/d51803d89125f962235d05cac5c2f5a1e80900e2))
* **i18n:** improve translation wording and consistency ([576e692](https://github.com/weiyilai/emailengine/commit/576e6924432beef0d0261a578494d703cf04d397))
* **i18n:** translate the remaining hosted form labels and refresh the catalogs ([b04784c](https://github.com/weiyilai/emailengine/commit/b04784ce7eed212b324b4e4dd39a9afcafd47da3))
...
* **imap:** run the shared arrival checks instead of IMAP wrappers ([26cd53c](https://github.com/weiyilai/emailengine/commit/26cd53c771ed8f6abbd740c22ef62319b54401a8))
* **imap:** share the bounce shape check with the API clients ([a0302a2](https://github.com/weiyilai/emailengine/commit/a0302a2ff40ab62f8fd5dfc68f26cbc9175d0059))
* **imap:** share the complaint shape check with the API clients ([90a9825](https://github.com/weiyilai/emailengine/commit/90a9825044fc024cf5977c5c56ccf5a484973cd4))
* **imap:** share the delivery-report shape check with the API clients ([aa777df](https://github.com/weiyilai/emailengine/commit/aa777dfefbe8047f7b7a6df7000fb95b89189a2c))
...
* **sso:** stop the forced-SSO hand-off flashing the login page before it leaves ([9e64618](https://github.com/weiyilai/emailengine/commit/9e646188feaced2ea77342abd4e6de49ad6ed169))
...
* **submit:** warn when the sent copy is skipped for lack of a Sent mailbox ([47fd10b](https://github.com/weiyilai/emailengine/commit/47fd10bdef5dc732265b10619122456d574942de))
* **test:** fail a stalled test run instead of waiting for the CI job to be killed ([9631512](https://github.com/weiyilai/emailengine/commit/9631512af363dd0b33b28f4c2ce4e2f996042b9d))
* **test:** follow the admin copy pass into the two specs it broke ([1524368](https://github.com/weiyilai/emailengine/commit/1524368de4b49a176b4338e810503bdca08fac3d))
* **test:** force the test runner to exit so one leaked handle cannot hang a tier ([bbdccdb](https://github.com/weiyilai/emailengine/commit/bbdccdb6af747ff96ee70ce688c275886d528d8c))
...
* **translations:** add Spanish, Italian and Turkish for the public UI ([d2089c3](https://github.com/weiyilai/emailengine/commit/d2089c3c6ab0a4b0c49e2d76a4fa62dc642bdd58))
* **translations:** add Swedish for the public UI ([048c086](https://github.com/weiyilai/emailengine/commit/048c0869b1645548be61cb77c0149963a8ac21af))
...
* **ui:** make the admin copy consistent and say what each screen actually does ([d7bb57d](https://github.com/weiyilai/emailengine/commit/d7bb57d949c8836c6946d3a9f53d3147e3e89ccb))
...
* **ui:** refine admin form labels and guidance ([eaa7d00](https://github.com/weiyilai/emailengine/commit/eaa7d0060f771136c0f248b8e906a628ce98795b))
...
* update dependencies to latest versions ([cd8b72c](https://github.com/weiyilai/emailengine/commit/cd8b72c21aa07f8437aa0aebaccbbb40c7ea9c0a))
...
* **deps:** collapse the duplicate nodemailer copies onto version 10 ([661a2ed](https://github.com/postalsys/emailengine/commit/661a2ed29325e775ecdbd86861428e1bf26c45a4))
* **deps:** update dependencies ([2f32929](https://github.com/postalsys/emailengine/commit/2f32929fe2624a393516701aad48b41a13b78c8e))
* **deps:** update dependencies and collapse the duplicate nodemailer copies ([09553a3](https://github.com/postalsys/emailengine/commit/09553a35817b3da040eca8fa3795ed5b9dcf470a))
...
* refuse to start below Node 20, the floor package.json declares ([1bf24eb](https://github.com/postalsys/emailengine/commit/1bf24eb5988164236ced87f64a528b12ac9af9f3))
...
* **auth:** replace unmaintained speakeasy and base32.js with in-house implementations ([9abaaaa](https://github.com/postalsys/emailengine/commit/9abaaaa4cfd1869788238db80860bbbb77694ed3))
...
* **deps:** replace deprecated msgpack5 with @msgpack/msgpack behind a compatibility wrapper ([9c40ebc](https://github.com/postalsys/emailengine/commit/9c40ebcc5b61993dad3f6979caab8cb8632b6ad0))
* **deps:** replace stagnant xml2js with fast-xml-parser in IMAP settings autodetection ([bfd6ec5](https://github.com/postalsys/emailengine/commit/bfd6ec5e7f0925fd3b0fb16a2a7490aa2cb14c27))
...
* **deps:** update email-text-tools and email-ai-tools to pull in patched dompurify (GHSA-55q2-fjhq-7xh7) ([148130f](https://github.com/postalsys/emailengine/commit/148130ff55680287fcd3902b5b5ff0ba9f4881de))
* **deps:** update imapflow to 1.7.0, certs to 1.0.17, templates to 2.0.2 ([cafae8c](https://github.com/postalsys/emailengine/commit/cafae8ca7b2429547bc60cf2932077af24bfa356))
...
* **oauth2:** fall back to stored credentials when useAuthServer is set but no auth server is configured ([cd460b0](https://github.com/postalsys/emailengine/commit/cd460b056673c5b148760ba25b670c4e75f1f344))
