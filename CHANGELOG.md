...
## [2.79.0](https://github.com/weiyilai/emailengine/compare/v2.78.0...v2.79.0) (2026-08-17)


### Features

* accept threadId on the submit reference object ([b1b3dc7](https://github.com/weiyilai/emailengine/commit/b1b3dc73ec5870a7a8ab9f0844055822ad046d2a))
...
* add direct account registration for email service account apps ([6602b2e](https://github.com/weiyilai/emailengine/commit/6602b2ee3f851bcfec00b34e70756007763f5490))
...
* add OAuth2 app "Verify setup" diagnostic ([cba9f58](https://github.com/weiyilai/emailengine/commit/cba9f58bc58a434c6156cd2e55fee655336a4cf4))
...
* add Workload Identity Federation for Gmail service accounts ([1879c5a](https://github.com/weiyilai/emailengine/commit/1879c5aaf30ccff1879e74d28b0c76e25b3d77ae))
...
* detect unsafe Redis eviction config in dashboard warnings ([712d5d6](https://github.com/weiyilai/emailengine/commit/712d5d69b99cc45c6f3e123a084ef054236e0110))
...
* handle MS Graph 'missed' lifecycle event for Outlook notification recovery ([d55f48c](https://github.com/weiyilai/emailengine/commit/d55f48c9a183f9e0108801563b1085c176dbeb06))
...
* lock Gmail auth method display after app creation ([6ba16c2](https://github.com/weiyilai/emailengine/commit/6ba16c2fbca571d500b21be776dbf5eb76fcf8a1))
...
* rebuild lost IMAP sync state without replaying messageNew ([9fe391e](https://github.com/weiyilai/emailengine/commit/9fe391e9d6350485aded780709305d698a4c65fb))
...
* revoke upstream OAuth2 grant on account delete via ?revoke=true ([2a8c8fa](https://github.com/weiyilai/emailengine/commit/2a8c8faf7f63acfab31998fb067289d4c6bd2f09))
* revoke upstream OAuth2 grant on account delete via ?revoke=true ([15bc43a](https://github.com/weiyilai/emailengine/commit/15bc43ae0f8dbf70021a1e13de55c80ec7271a15))
...
* show curl example for service account OAuth2 apps ([4ab5eda](https://github.com/weiyilai/emailengine/commit/4ab5edabf64373e8b2dd4bb0ea658847d40ba904))
* show human-readable missing scopes on OAuth scope error page ([4ee2365](https://github.com/weiyilai/emailengine/commit/4ee2365449e3cbece6f4a83d540ae63c18464535))
...
* use tabs for Gmail auth method and lock it after creation ([6c74521](https://github.com/weiyilai/emailengine/commit/6c7452138c257ecf0667aa9b44d1fa91186e2302))
...
* add IMAP fetch retry timeout and harden passkey registration ([3a1b61b](https://github.com/weiyilai/emailengine/commit/3a1b61b00e916c308cae5e7493a2207164d9d45f))
...
* bound inbound line length in the IMAP proxy parser ([9fb8a5e](https://github.com/weiyilai/emailengine/commit/9fb8a5e301564dee46b48ca32a5b84e4832d96e8))
* broken Handlebars script tag, Okta session fall-through, login rate limiting, and passkey schema validation ([01e5721](https://github.com/weiyilai/emailengine/commit/01e5721ee02ad66ce9c30b58c406988b1cfd1ae3))
...
* clear passkey credentials on CLI password reset and document remember-me behavior ([35f7f00](https://github.com/weiyilai/emailengine/commit/35f7f00970b7e7f3a514d2ea0d97fce5320f6e1b))
...
* clearer error when loading wrong file into WIF config field ([40686d4](https://github.com/weiyilai/emailengine/commit/40686d409229347193c1e153e9e47f98b5de86dc))
* close command client proactively after subconnection setup ([02d3687](https://github.com/weiyilai/emailengine/commit/02d36874d8533beabe5ad0fba978851b3791cbb5))
* close leaks and a worker crash found in the connection hardening review ([e97950e](https://github.com/weiyilai/emailengine/commit/e97950e7e907ac5b5549302b8865c5d2bfb0d6e2))
...
* correct translation errors and remove EmailEngine branding from OAuth scope error ([9284ddd](https://github.com/weiyilai/emailengine/commit/9284ddd1e28e40fd24abeea7296636b21c4b3878))
...
* detect IMAP drift that landed during an in-progress sync ([8fece8a](https://github.com/weiyilai/emailengine/commit/8fece8ad6f3acb5e7391da7a9740279099f62177))
...
* distinguish SO_REUSEPORT fallback cause in logs and admin UI ([99ad9f3](https://github.com/weiyilai/emailengine/commit/99ad9f3359eab5bafc4726535584874d4823f7bd))
...
* do not prefill login username field ([59835a8](https://github.com/weiyilai/emailengine/commit/59835a84f3e2a01c6461f29ecb80763dc4a42fe2))
...
* drain webhook response body on every delivery path ([2cc3e7a](https://github.com/weiyilai/emailengine/commit/2cc3e7aef114b5b913dea5c363278e1a883d5a48))
...
* flag WIF support in the gmailService form intro ([61fab27](https://github.com/weiyilai/emailengine/commit/61fab2720aa2f289a944ae99629bc47ada8e9e09))
* force-exit external-account-signer test to unblock CI ([f4a1e4e](https://github.com/weiyilai/emailengine/commit/f4a1e4e50ac890d7771e38181a9488837c67757a))
...
* guard IMAP notification handlers against malformed events ([0248953](https://github.com/weiyilai/emailengine/commit/0248953a5dcccba5d46704bf7113a70fb5ac3150))
* guard webhook notifications in BullMQ failure handlers ([e90048e](https://github.com/weiyilai/emailengine/commit/e90048e7b7bd92916219602f92305342234df4a3))
...
* harden IMAP proxy STARTTLS against command injection ([3661ddd](https://github.com/weiyilai/emailengine/commit/3661dddbf216b29ec8f074d3f6422dd4db5d9e7b))
* harden inter-thread IPC (worker-death call rejection, webhook guards, stream cleanup) ([0111a8e](https://github.com/weiyilai/emailengine/commit/0111a8e2bf139c3412cc37e5e933fd5316cee8fc))
* harden mergeObjects and tighten CodeQL scanning ([d35025d](https://github.com/weiyilai/emailengine/commit/d35025daabf8fe7b3f5200b0000f52c3a012f4eb))
* harden message export against data loss and corruption ([540d867](https://github.com/weiyilai/emailengine/commit/540d8678ec25f62e8123fc78fa929f4e4713b5d4))
* harden multiple-API-worker startup and centralize proxy-agent reload ([7f2db9e](https://github.com/weiyilai/emailengine/commit/7f2db9e557d960aa1b7523b7d8678598683c2f29))
* harden passkey auth, IMAP sync error handling, and login form UX ([c16b983](https://github.com/weiyilai/emailengine/commit/c16b98312f35d87fd8b21974a7eb7eca6459cc3b))
* harden passkey authentication with validation, rate limits, and audit logging ([75dd289](https://github.com/weiyilai/emailengine/commit/75dd289940e7345fa56246c90ff6bc8d01694e6c))
...
* improve translation quality across 6 languages ([d7d338e](https://github.com/weiyilai/emailengine/commit/d7d338e761152909d4c2ca4732fafb60529413ab))
...
* let npm run gettext parse object spread and drop non-ASCII from template ([195ce60](https://github.com/weiyilai/emailengine/commit/195ce601db50f394164ca05e2efb6de4b784a77a))
...
* mask externalAccount in OAuth2 app API responses ([fac18bf](https://github.com/weiyilai/emailengine/commit/fac18bfdc11d5d252e0d93980aad7c90d92b246f))
...
* normalize copy across login and security pages ([60e132a](https://github.com/weiyilai/emailengine/commit/60e132a9e4e8f96fc621b4b454f95896fb4d48c1))
* normalize sign-in/sign-out copy to sentence case ([1ccfb16](https://github.com/weiyilai/emailengine/commit/1ccfb167a674d887af0ac2db8df3ff434f23e5bb))
...
* per-IP passkey rate limiting and credential ownership check ([2455cbe](https://github.com/weiyilai/emailengine/commit/2455cbe9d6af5d6eff8ae81ecc335b6820bfc904))
* pin undici to 7.25.0 for Node 20 compatibility ([3fa80db](https://github.com/weiyilai/emailengine/commit/3fa80db4d64d6fe089fa3a1a0e700a188aeb74f7))
* pkg config options must be a string array ([6c4702d](https://github.com/weiyilai/emailengine/commit/6c4702dbc85171a2987b8cfb6e5a3dc3d656a99d))
...
* prefer refresh token and skip gmailService when revoking on delete ([e0dbea8](https://github.com/weiyilai/emailengine/commit/e0dbea8a4cd4804bf64d50523c8a1152c2119e26))
* prevent IMAP proxy worker crashes and connection leaks ([#596](https://github.com/weiyilai/emailengine/issues/596)) ([4453330](https://github.com/weiyilai/emailengine/commit/4453330ad38fb3e64692add1357d48227e1956e0))
* prevent IMAP worker crash on download stream errors ([d9d5396](https://github.com/weiyilai/emailengine/commit/d9d539632cc245a8e2a14585fc7918186bee00b6))
* prevent message event loss during IMAP sync under heavy load ([ceb139b](https://github.com/weiyilai/emailengine/commit/ceb139b825eaf7fc06bf1c88b9bcc89824abbcdb))
* prevent open redirects via next parameter and require password for passkey registration ([0e7f52a](https://github.com/weiyilai/emailengine/commit/0e7f52ada9687234682027ecb93e81515fcb9dbb))
...
* prevent post-BYE command dispatch in IMAP proxy teardown ([d51e92d](https://github.com/weiyilai/emailengine/commit/d51e92d298e9373a6dc5c2eb0919885e161b45c7))
...
* re-arm a generous idle timeout for proxied IMAP connections ([627c6d4](https://github.com/weiyilai/emailengine/commit/627c6d472e50f6fc3e958e4774226557a526018d))
...
* reject in-flight worker calls when a worker thread terminates ([08e7b01](https://github.com/weiyilai/emailengine/commit/08e7b0128a4b8e9f9e5a96fefe49110bd032bd2c))
* reject OAuth2 grants with missing Google granular consent scopes ([3f277d1](https://github.com/weiyilai/emailengine/commit/3f277d1428e4a861752eb18b5d74279afefd1efa))
* relax cross-folder assertion in Graph API parentFolderId test ([770279d](https://github.com/weiyilai/emailengine/commit/770279ded669efdc5d6a2c33d05290daf91251ea))
* release cross-thread download streams on abort and error ([6514249](https://github.com/weiyilai/emailengine/commit/65142499d095bbcb5f0bb49755a2e24f6e52fa62))
* release MessagePort streams when message/attachment downloads fail ([787f4f5](https://github.com/weiyilai/emailengine/commit/787f4f5ef6364ec1389c15269c8f7f8eaaa2142a))
* remove password hash from error logs and update passkey description copy ([d28dd16](https://github.com/weiyilai/emailengine/commit/d28dd16e61fc84d0800546c4f33d4535f52e2a22))
...
* resolve OAuth2 provider for delegated Outlook accounts ([f35c816](https://github.com/weiyilai/emailengine/commit/f35c816e3149eeaa568d86c06fa6783c649c54c5))
...
* restore IMAP XOAUTH2 path for gmailService accounts ([d2ebe9b](https://github.com/weiyilai/emailengine/commit/d2ebe9b3c19cd0bcaaf0fa17d40148f79dd7cd2b))
...
* return the append destination folder from uploadMessage ([96aed6b](https://github.com/weiyilai/emailengine/commit/96aed6b1144e1d3ee9da79b3a1fb03606245f83c))
...
* right-align the service account Add account button ([c6f77b9](https://github.com/weiyilai/emailengine/commit/c6f77b9777fb1cb9b1449662d05d4887e36a6ad8))
...
* stop referencing prepared password string in error log ([50cdb89](https://github.com/weiyilai/emailengine/commit/50cdb8998e27f33f700f267cb39ddba39e7d32d0))
...
* tear down subconnections when deleting an IMAP account ([bd81a33](https://github.com/weiyilai/emailengine/commit/bd81a33caf9400cbee2781a9180f1a901c1d6e48))
...
* update client-side Handlebars to 4.7.9 and harden passkey input validation ([882891c](https://github.com/weiyilai/emailengine/commit/882891c36ed3704d96ccf227e682e152f5395036))
...
* upgrade handlebars to 4.7.9 to resolve prototype pollution vulnerability ([452f5f5](https://github.com/weiyilai/emailengine/commit/452f5f54f4007e4b765e18861ce01cde312cc83c))
...
* use STATUS instead of NOOP as keepalive for 163.com IMAP ([3b3516f](https://github.com/weiyilai/emailengine/commit/3b3516feb14e64bab5ac586378237f2160cdf010))
* use template literals for translated strings in showErrorPopup ([b56fd1f](https://github.com/weiyilai/emailengine/commit/b56fd1fa7612b4cf2b7e99cbd78d7447b89c03c6))
...
* optimize mailbox listing for accounts with many folders ([a39e5f7](https://github.com/weiyilai/emailengine/commit/a39e5f7b02156fc73ab44d1ca4f6e977e4290312))
